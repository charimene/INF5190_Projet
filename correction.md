...
## A1
les fonctionnalitées de A1 sont executées, crée et sauvegarde les fichiers necessaires(donnees.csv et donnees.xml) dans le dossier /donnees du projet, lors du premier appel de la route principale de l'application "/" grace au decorateur : "@app.before_first_request"
...
- Lecture apartir du fichier XML et extraction de donnees de chaque poursuite et les inserer dans les table qui constitue la base de données.
